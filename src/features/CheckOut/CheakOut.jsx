...
function CheckOut() {
  ...
  const updateCartSummary = (updatedItems) => {
    const total = updatedItems.reduce((sum, item) => sum + item.product.discountPrice * item.quantity, 0);
  ...
  return (
    <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
      <div className="grid grid-cols-1 gap-x-8 gap-y-10 lg:grid-cols-5">
        {/* Address form and existing addresses */}
        <div className="lg:col-span-3">
          {/* Form for personal details and address */}
              ...
              <fieldset>
                ...
                <div className="mt-6 space-y-6">
                  <div className="flex items-center gap-x-3">
                    <input id="cash" name="payments" value="cash" type="radio" className="h-4 w-4 border-gray-300 text-indigo-600 focus:ring-indigo-600" />
                    <label htmlFor="cash" className="block text-sm font-medium leading-6 text-gray-900">Cash</label>
                  </div>
                  <div className="flex items-center gap-x-3">
                    <input id="card" name="payments" value="card" type="radio" className="h-4 w-4 border-gray-300 text-indigo-600 focus:ring-indigo-600" />
        ...
        <div className="lg:col-span-2">
          <div className="mx-auto mt-12 bg-white max-w-7xl px-4 sm:px-6 lg:px-8">
            ...
            <div className="border-t border-gray-200 px-4 sm:px-6">
              ...
              <p className="mt-0.5 text-sm text-gray-500">Total Items in cart: {totalItems}</p>
              <div className="mt-6">
